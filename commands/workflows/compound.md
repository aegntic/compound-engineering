...
- **test_failure** → `laravel-reviewer` + `code-simplicity-reviewer`
- Any code-heavy issue → `laravel-reviewer` + `code-simplicity-reviewer`
...
Specialized Agent Reviews (Auto-Triggered):
  ...
  ✓ laravel-reviewer: Code examples meet project standards
...
### Code Quality & Review
- **laravel-reviewer**: Reviews code examples for Laravel best practices
...
- **laravel-reviewer**: Reviews code examples for prevention test strategies
- **data-integrity-guardian**: Reviews database_issue migrations and queries

### Enhancement & Documentation
- **best-practices-researcher**: Enriches solution with industry best practices
- **vue-reviewer**: Reviews frontend code for Vue.js conventions
